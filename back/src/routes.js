...
import {insertUsuario, updateUsuario, selectUsuarios, selectUsuario, deleteUsuario, logar, codigo, confirmarCodigo, updatePassword} from './Controler/Usuarios.js';
...
router.put('/password', updatePassword);//Atualização dos dados de uma pessoa
